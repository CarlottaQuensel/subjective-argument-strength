...
if __name__ == '__main__':
    ...
    parser.add_argument("variable", type=str)  # masked or unmasked
    parser.add_argument("num_splits", type=int)
    parser.add_argument("epochs", type=int)
    args = parser.parse_args()

    # Make output and temp folders if they don't exist
    dest_folder = "results/emotions/"+args.variable
    ...
    for emotion in emotion_labels:
        ...
        if os.path.isfile(dest_folder + "/ibm_" + emotion + "_predictions.csv"):
            ...
            emo_data = pd.read_csv(
                f"data/emotions/{args.variable}/crowd-enVent_{emotion}.csv", sep="\t")
            print("Loaded training data from <==",
                  f"data/emotion/{args.variable}/crowd-enVent_{emotion}.csv")
    ...
    cmv.to_csv(dest_folder+f"/cmv_with_emo_{args.variable}.csv", sep="\t")
    ibm.to_csv(dest_folder+f"/ibm_with_emo_{args.variable}.csv", sep="\t")
